...
const MOCK_EVENTS = [
    {
        ...
        description: "Une soir├®e m├®morable pour accueillir les nouveaux ├®tudiants. Buffet, musique et rencontres au programme de cette ├®dition exceptionnelle qui a rassembl├® plus de 500 personnes."
    },
    {
        id: 2,
        ...
        description: "Comp├®tition intense sur les titres les plus populaires du moment. Une journ├®e d├®di├®e ├á la passion du jeu vid├®o avec des lots exceptionnels pour les vainqueurs."
    },
    {
        id: 3,
        title: "Forum Carri├¿res",
        date: "10 Nov 2025",
        location: "Hall Principal",
        type: "Professionnel",
        image: "https://images.unsplash.com/photo-1540575861501-7ad0606b7ad3?auto=format&fit=crop&q=80&w=800",
        description: "Rencontre entre ├®tudiants et entreprises leaders du secteur. Ateliers CV, simulations d'entretiens et networking pour lancer sa carri├¿re professionnelle."
    },
];
        ...
        <section id="events" className="w-full py-24 px-4 relative z-10">
            <div className="container mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-black">Nos ├ëv├®nements Pass├®s</h2>
