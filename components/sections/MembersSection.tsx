...
const MOCK_MEMBERS = [
    { id: 1, name: "Alice Freeman", role: "Présidente", src: "https://i.pravatar.cc/150?u=a042581f4e29026024d", socials: { ig: "#", li: "#" } },
    { id: 2, name: "Bob Smith", role: "Secrétaire Général", src: "https://i.pravatar.cc/150?u=a042581f4e29026704d", socials: { ig: "#", li: "#" } },
    { id: 3, name: "Charlie Davis", role: "Trésorier", src: "https://i.pravatar.cc/150?u=a04258a2462d826712d", socials: { ig: "#", li: "#" } },
    { id: 4, name: "Diana Prince", role: "Resp. Com", src: "https://i.pravatar.cc/150?u=a04258114e29026702d", socials: { ig: "#", li: "#" } },
    { id: 5, name: "Ethan Hunt", role: "Resp. Événementiel", src: "https://i.pravatar.cc/150?u=a04258114e29026708d", socials: { ig: "#", li: "#" } },
    { id: 6, name: "Fiona Gallagher", role: "Relations Extérieures", src: "https://i.pravatar.cc/150?u=a04258114e29026709d", socials: { ig: "#", li: "#" } },
];
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-xs text-slate-500 mt-4 line-clamp-2 leading-relaxed max-w-[200px]">
                                    Dédié au développement de la vie étudiante et à l'organisation d'événements marquants.
                                </p>
